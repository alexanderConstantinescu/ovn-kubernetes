...
func (n *OvnNode) initLocalnetGateway(subnet *net.IPNet, nodeAnnotator kube.Annotator) error {
	...
	if config.Gateway.NodeportEnable {
		err = n.localnetNodePortWatcher(ipt, gatewayIP, gatewayNextHop)
	}
...
func (n *OvnNode) localnetNodePortWatcher(ipt util.IPTablesHelper, gatewayIP, gatewayNextHop net.IP) error {
	...
	npw := &localnetNodePortWatcherData{ipt: ipt, gatewayIP: gatewayIP.String(), gatewayNextHopIP: gatewayNextHop.String(), recorder: n.recorder}
