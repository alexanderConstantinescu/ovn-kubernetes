		...
		ginkgo.It("reconciles an existing egressFirewall with IPv4 CIDR", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 --id=@node1-10000 create acl priority=10000 direction=from-lport match=\"(ip4.dst == 1.2.3.4/23) && ip4.src == $a10481622940199974102\" action=allow external-ids:egressFirewall=namespace1 -- add logical_switch node1 acls @node1-10000",
				})
		...
		ginkgo.It("reconciles an existing egressFirewall with IPv6 CIDR", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 --id=@node1-10000 create acl priority=10000 direction=from-lport match=\"(ip6.dst == 2002::1234:abcd:ffff:c0a8:101/64) && (ip4.src == $a10481622940199974102 || ip6.src == $a10481620741176717680)\" action=allow external-ids:egressFirewall=namespace1 -- add logical_switch node1 acls @node1-10000",
				})
		...
		ginkgo.It("correctly creates an egressfirewall denying traffic udp traffic on port 100", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 --id=@node1-10000 create acl priority=10000 direction=from-lport match=\"(ip4.dst == 1.2.3.4/23) && ip4.src == $a10481622940199974102 && ((udp && ( udp.dst == 100 )))\" action=drop external-ids:egressFirewall=namespace1 -- add logical_switch " + node1Name + " acls @node1-10000",
				})
				namespace1 := *newNamespace("namespace1")
				egressFirewall := newEgressFirewallObject("default", namespace1.Name, []egressfirewallapi.EgressFirewallRule{
					{
		...
		ginkgo.It("correctly deletes an egressfirewall", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 --id=@node1-10000 create acl priority=10000 direction=from-lport match=\"(ip4.dst == 1.2.3.5/23) && ip4.src == $a10481622940199974102 && ((tcp && ( tcp.dst == 100 )))\" action=allow external-ids:egressFirewall=namespace1 -- add logical_switch node1 acls @node1-10000 -- --id=@node2-10000 create acl priority=10000 direction=from-lport match=\"(ip4.dst == 1.2.3.5/23) && ip4.src == $a10481622940199974102 && ((tcp && ( tcp.dst == 100 )))\" action=allow external-ids:egressFirewall=namespace1 -- add logical_switch node2 acls @node2-10000",
				})
				fExec.AddFakeCmd(&ovntest.ExpectedCmd{
		...
		ginkgo.It("correctly updates an egressfirewall", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 remove logical_switch node1 acls " + fmt.Sprintf("%s", fakeUUID) + " -- --id=@node1-10000 create acl priority=10000 direction=from-lport match=\"(ip4.dst == 1.2.3.4/23) && ip4.src == $a10481622940199974102\" action=drop external-ids:egressFirewall=namespace1 -- add logical_switch node1 acls @node1-10000",
				})
		...
		ginkgo.It("reconciles an existing egressFirewall with IPv4 CIDR", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 --id=@join-10000 create acl priority=10000 direction=from-lport match=\"(ip4.dst == 1.2.3.4/23) && ip4.src == $a10481622940199974102 && inport == \\\"" + t.JoinSwitchToGWRouterPrefix + t.OVNClusterRouter + "\\\"\" action=allow external-ids:egressFirewall=namespace1 -- add logical_switch join acls @join-10000",
				})
		...
		ginkgo.It("reconciles an existing egressFirewall with IPv6 CIDR", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 --id=@join-10000 create acl priority=10000 direction=from-lport match=\"(ip6.dst == 2002::1234:abcd:ffff:c0a8:101/64) && (ip4.src == $a10481622940199974102 || ip6.src == $a10481620741176717680) && inport == \\\"" + t.JoinSwitchToGWRouterPrefix + t.OVNClusterRouter + "\\\"\" action=allow external-ids:egressFirewall=namespace1 -- add logical_switch join acls @join-10000",
				})
		...
		ginkgo.It("correctly creates an egressfirewall denying traffic udp traffic on port 100", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 --id=@join-10000 create acl priority=10000 direction=from-lport match=\"(ip4.dst == 1.2.3.4/23) && ip4.src == $a10481622940199974102 && ((udp && ( udp.dst == 100 ))) && inport == \\\"" + t.JoinSwitchToGWRouterPrefix + t.OVNClusterRouter + "\\\"\" action=drop external-ids:egressFirewall=namespace1 -- add logical_switch join acls @join-10000",
				})
				namespace1 := *newNamespace("namespace1")
				egressFirewall := newEgressFirewallObject("default", namespace1.Name, []egressfirewallapi.EgressFirewallRule{
					{
		...
		ginkgo.It("correctly deletes an egressfirewall", func() {
			app.Action = func(ctx *cli.Context) error {
				...
				fExec.AddFakeCmdsNoOutputNoError([]string{
					...
					"ovn-nbctl --timeout=15 --id=@join-10000 create acl priority=10000 direction=from-lport match=\"(ip4.dst == 1.2.3.5/23) && ip4.src == $a10481622940199974102 && ((tcp && ( tcp.dst == 100 ))) && inport == \\\"" + t.JoinSwitchToGWRouterPrefix + t.OVNClusterRouter + "\\\"\" action=allow external-ids:egressFirewall=namespace1 -- add logical_switch join acls @join-10000",
				})
				fExec.AddFakeCmd(&ovntest.ExpectedCmd{
					Cmd:    "ovn-nbctl --timeout=15 --data=bare --no-heading --columns=_uuid find ACL external-ids:egressFirewall=namespace1",
					Output: fmt.Sprintf("%s", fakeUUID),
	...
	ginkgo.It("computes correct match function", func() {
		...
		testcases := []testcase{
			...
			},
			{
				...
				ipv4source:   "testv4",
				ipv6source:   "",
				destination:  matchTarget{matchKindV4AddressSet, "destv4"},
				ports:        nil,
		...
		for _, tc := range testcases {
			...
			config.Gateway.Mode = config.GatewayModeShared
			matchExpression, err := generateMatch(tc.ipv4source, tc.ipv6source, tc.destination, tc.ports)
			gomega.Expect(err).NotTo(gomega.HaveOccurred())
