...
// GetNodeGatewayRouterAddress returns the IPs (IPv4 and/or IPv6) of the provided node's gateway router
func GetNodeGatewayRouterAddress(nodeName string) (net.IP, net.IP, error) {
